...
- [◐] A signed-in pass in a real browser — **four of seven confirmed by the site owner, 2026-08-26**
...
| 5 | Both chips against real data after a reload | ⏭️ outstanding |
| 6 | By eye: pressed state, `Featured` / `Your pin`, the chip rule, dark mode | ⏭️ outstanding |
| 7 | Sign out clears the personal layer | ⏭️ outstanding |
